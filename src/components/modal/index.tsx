    ...
    return (
      <>
        <div className="flex items-center justify-center " >
          <div
            className={`flex gap-2 justify-center items-center flex-col p-6 fixed z-50 rounded-lg bottom-20 backdrop-blur-md bg-gray-300 container h-[80%] md:h-[40%] w-[40%] transition-all duration-[.1s] ease-linear opacity-0 -mb-96 ${
          ...
          >
            ...
            <Text variant="subtitle" content="You found an easter egg" className="text-center"/>
